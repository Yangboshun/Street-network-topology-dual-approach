...
LSGI Department, Hong Kong Polytechnic University

This project supports my own report, it was interesting to explore the underlying characteristics of the street network. I used python to call openstreetmap data for a dual approach to modeling based on street continuity. These are codes that apply to regions all over the world., while supporting continuity negotiation with Every best-fit strategy.
